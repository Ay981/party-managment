...
import type { CompanyParty, PaginationMeta } from '@/modules/party-management/types'
          ...
          <div className="flex max-w-xs flex-col items-center gap-3 text-center">
            ...
            {hasFilters && (
              <button
                ...
                className={cn(
                  'inline-flex h-9 items-center rounded-lg px-3.5 text-xs font-medium',
            ...
            {!hasFilters && onSeedDemo && (
              <div className="flex flex-col items-center gap-2">
                <button
                  ...
                  className={cn(
                    'inline-flex h-9 items-center gap-2 rounded-lg border px-3.5 text-xs font-semibold shadow-sm',
                ...
                <p className="text-xs text-amber-700 dark:text-amber-300">
                  Demo only: adds sample parties to this browser.
                </p>
              </div>
            )}
          </div>
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className={cn(
            ...
            'text-zinc-600 transition-[background-color,transform] duration-150 hover:bg-zinc-100 active:scale-[0.97] dark:text-zinc-400 dark:hover:bg-zinc-800',
          ...
          return (
            <div key={page} className="flex items-center gap-1">
              ...
              <button
                ...
                className={cn(
                  'inline-flex size-8 items-center justify-center rounded-md text-xs font-medium transition-[background-color,transform] duration-150 active:scale-[0.97]',
                  page === meta.page
          ...
          <tbody className="divide-y divide-zinc-100 bg-white dark:divide-zinc-800 dark:bg-zinc-950">
            ...
            {!isLoading && parties.map(party => (
              ...
              >
                ...
                <td className="px-4 py-3">
                  <span className="font-mono text-xs text-zinc-500 dark:text-zinc-500 tabular-nums">
                    {maskTin(party.tin)}
                  </span>
                </td>
